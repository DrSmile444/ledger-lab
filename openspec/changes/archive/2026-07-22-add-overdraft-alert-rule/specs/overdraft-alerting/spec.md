...
The system SHALL treat a last-alert timestamp that is at or after the current evaluation time as invalid and SHALL NOT let it suppress an otherwise-due alert.
